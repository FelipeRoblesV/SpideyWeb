    ...
    <body class="animsition site-navbar-small dashboard">
        ...
        <div class="page">
            <div class="page-header">
                <h1 class="page-title">Evaluacion</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a>WFBS</a></li>
                    <li class="breadcrumb-item"><a href="evaluacion-index.jsp">Evaluacion</a></li>
                </ol>
            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body collapse show" id="exampleFooAccordionPanel">
                            <table class="table table-hover table-bordered table-striped toggle-arrow-tiny"
                                   ...
                                   data-sorting="true" data-show-toggle="true" data-toggle-column="first">
                                <thead>
                                    <tr>
                                        <th data-name="nombreEvaluacion">Codigo Evaluacion</th>
                                        <th data-name="periodoEvaluacion">Periodo Evaluacion</th>
                                        <th data-name="lastName">Dias vigentes</th>
                                        
                                        <th data-name="jobTitle" data-breakpoints="all">Area de trabajo</th>
                                        <th data-name="started" data-type="date" data-breakpoints="all" data-format-string="MMM YYYY">Evaluado</th>
                                        <th data-name="started" data-type="date" data-breakpoints="all" data-format-string="MMM YYYY">Evaluador</th>
                                        <th data-name="started" data-type="date" data-breakpoints="all" data-format-string="MMM YYYY">total preguntas</th>
                                        <th data-name="status" data-breakpoints="all">Ingresar</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>EVA-01</td>
                                        <td>19-09-2000 - 15-09-2000</td>
                                        <td>12</td>
                                        <td>Homicidio</td>
                                        <td>Miles Morales</td>
                                        <td>Peter Parker</td>
                                        <td>20</td>
                                        <td><a href="evaluacion-intrucciones.jsp">Boton temporal (Ingresar)</a></td>
